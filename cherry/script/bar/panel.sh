...
while true; do
	printf "%s\n" "%{l}%{B$BG0}%{B$MENU}%{F$BG1} λ Arch %{B$BG0} %{F$FG}Now Playing %{F$FG1}♫%{B$BG1} %{B$BG2} %{F$BG0}$(NowPlaying) %{B$BG0}%{F$FG} Vol %{F$FG1}$(Volume) %{F$FG}%{B$BG0}%{B$BG1} %{c} %{B$BG1} %{B$BG0} [ $(Workspace) ] %{B$BG1} %{r} %{B$BG1} %{B$BG0} Cpu: %{F$FG1}$(Cpu)%% %{F$FG}Gpu: %{F$FG1}$(Gpu)°C %{F$FG}Mem: %{F$FG1}$(Mem)%% %{F$FG}Battery%{B$BG1} %{F$BG0}%{B$BG2} $(Battery) %{F$FG}%{B$BG1} %{B$BG0}Time %{F$FG1}$(Clock) %{B$BG1}"
